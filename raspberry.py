            ...
            for hand_index, hand_landmarks in enumerate(
                ...
                if recognition_result_list[0].gestures:
                    ...
                    if category_name == "Thumb_Up":
                        GESTURES["thumb_up_count"] += 1
                        if GESTURES["thumb_up_count"] == 10:
                            res = requests.get(
                                "https://swcn.api.cocoiot.com/ha/controls/light_on/"
                            )
                            if res.status_code == 204:
                                GESTURES["thumb_up_count"] = 0
...
def main():
    ...
    parser.add_argument(
        ...
        required=False,
        default="./tasks/gesture_recognizer.task",
    )
    parser.add_argument(
        "--numHands",
